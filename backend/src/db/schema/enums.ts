...
export const companySizeEnum = pgEnum("company_size", ["small", "medium", "large", "enterprise", "unknown"]);
...
export const sentimentEnum = pgEnum("sentiment", ["positive", "negative", "neutral", "out_of_office"]);
...
export const suppressionReasonEnum = pgEnum("suppression_reason", ["unsubscribed", "manual"]);
