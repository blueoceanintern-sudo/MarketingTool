...
export const sentimentEnum = pgEnum("sentiment", ["positive", "negative", "neutral", "out_of_office", "hostile"]);
...
export const suppressionReasonEnum = pgEnum("suppression_reason", ["unsubscribed", "manual", "hostile"]);
